...
export const FOOTER_INFO = '<sup>*</sup> Вся представленная на сайте информация, касающаяся автомобилей и сервисного обслуживания, носит информационный характер и не является публичной офертой, определяемой положениями ст. 437 ГК РФ. Все цены, указанные на данном сайте, носят информационный характер. Для получения подробной информации просьба обращаться к менеджерам отдела продаж по номеру телефона '+phones.join(', ')+'. Опубликованная на данном сайте информация может быть изменена в любое время без предварительного уведомления.<br/> Ежемесячный платеж по кредиту по акционной программе кредитования «HavalDirect» (Хавал Директ) для новых автомобилей иностранных марок 2025 года выпуска составляет 13 044 рубля. Расчет произведен исходя из следующих параметров: цена автомобиля HAVAL 2 089 000,00 рублей, первоначальный взнос 1 462 300,00 рублей (70% от стоимости автомобиля); срок кредита – 48 месяцев; полная стоимость кредита на момент заключения Договора – 626 700,00 рублей, процентная ставка – 0,01% годовых. Расчет платежа произведен на 18.09.2025 года, является предварительным и может отличаться от фактического при изменении параметров/даты предоставления кредита. Срок акции – с 18.09.2025 г. по 30.09.2025г. Кредит предоставляется ПАО «Сбербанк» (Генеральная лицензия Банка России № 1481 от 11.08.2015г.)';

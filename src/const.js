...
export const FOOTER_INFO = '<sup>*</sup> Вся представленная на сайте информация, касающаяся автомобилей и сервисного обслуживания, носит информационный характер и не является публичной офертой, определяемой положениями ст. 437 ГК РФ. Все цены, указанные на данном сайте, носят информационный характер. Для получения подробной информации просьба обращаться к менеджерам отдела продаж по номеру телефона '+phones.join(', ')+'. Опубликованная на данном сайте информация может быть изменена в любое время без предварительного уведомления. <br/>Минимальный ежемесячный платеж по кредиту по акционной программе кредитования «HavalDirect» (Хавал Директ) для новых автомобилей иностранных марок 2025 года выпуска составляет 10 022,90 рубля. Расчет произведен исходя из следующих параметров: цена автомобиля HAVAL – 2 400 000,00 рублей, первоначальный взнос – 1 919 000,00 рублей (79% от стоимости автомобиля); срок кредита – 48 месяцев; полная стоимость кредита на момент заключения Договора – 481 000,00 рублей, процентная ставка – 0,01% годовых. Расчет платежа произведен на 16.10.25, является предварительным и может отличаться от фактического при изменении параметров/даты предоставления кредита. Срок акции – с 16.10.2025 г. По 31.10.25г. Кредит предоставляется АО «ТБанк». (Генеральная лицензия Банка России № 2673).';
